...
export const getArticlesPageView = (state: StateSchema): ArticleView => state.articlesPage?.view || 'small';
...
export const getArticlesPageSort = (state: StateSchema): ArticleSortField => state.articlesPage?.sort ?? 'createdAt';
